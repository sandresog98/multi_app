...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo cx_repo_base_url(); ?>/cx/assets/css/footer.css?v=<?php echo time(); ?>">
    ...
    <style>
      ...
      .brand-title { font-weight: 700; margin: 0; font-size: 1.5rem; }
      .brand-sub { opacity:.9; font-size: 0.9rem; }
