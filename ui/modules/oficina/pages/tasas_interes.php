        ...
        <div class="modal-body">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              ...
              <div class="input-group">
                <input type="text" name="seguro_vida" class="form-control decimal-input" placeholder="0.0000" value="0">
                <span class="input-group-text">%</span>
              </div>
            </div>
            <div class="col-md-6">
              ...
              <div class="input-group">
                <input type="text" name="seguro_deudores" class="form-control decimal-input" placeholder="0.0000" value="0">
                <span class="input-group-text">%</span>
              </div>
            </div>
          </div>
        ...
        <div class="modal-body">
          ...
          <div class="row g-3">
            ...
            <div class="col-md-6">
              <label class="form-label">Seguro de Vida</label>
              <div class="input-group">
                <input type="text" name="seguro_vida" class="form-control decimal-input" placeholder="0.0000" 
            ...
            <div class="col-md-6">
              <label class="form-label">Seguro de Deudores</label>
              <div class="input-group">
                <input type="text" name="seguro_deudores" class="form-control decimal-input" placeholder="0.0000" 
